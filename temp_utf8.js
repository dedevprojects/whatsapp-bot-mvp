...
async function connectBusiness(whatsappNumber, businessName = 'Unknown') {
    ...
    // ÔöÇÔöÇÔöÇ Credentials update ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    sock.ev.on('creds.update', saveCreds);

    // ÔöÇÔöÇÔöÇ Connection state changes ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
    sock.ev.on('connection.update', async (update) => {
        const { connection, lastDisconnect, qr } = update;

        if (qr) {
            qrCodes.set(whatsappNumber, qr);
            logger.info({ businessName, whatsappNumber }, 'QR code ready ÔÇö scan to connect');
            console.log(`\n­ƒô▓  Scan QR for [${businessName}] (${whatsappNumber}):\n`);
            qrcode.generate(qr, { small: true });
        }

        if (connection === 'open') {
            qrCodes.delete(whatsappNumber);
            logger.info({ businessName, whatsappNumber }, 'Ô£à WhatsApp connected successfully');
        }
        ...
        if (connection === 'close') {
            ...
            if (shouldReconnect) {
                const delay = 5000;
                logger.info({ businessName, whatsappNumber, delay }, 'ReconnectingÔÇª');
                setTimeout(() => connectBusiness(whatsappNumber, businessName), delay);
            } else {
                logger.error({ businessName, whatsappNumber }, 'Logged out ÔÇö session cleared');
                connections.delete(whatsappNumber);
            }
        }
    });

    // ÔöÇÔöÇÔöÇ Incoming messages ÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇÔöÇ
